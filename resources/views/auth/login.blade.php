                        ...
                        <div class="col-md-7 p-4 p-sm-5" style="background-color: rgba(30, 30, 30, 0.95);">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="email" type="email" class="form-control bg-dark border-secondary text-white py-2 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                </div>

                                <div class="mb-3">
                                    <label for="password" class="form-label text-light small fw-semibold">{{ __('Contraseña') }}</label>
                                    <input id="password" type="password" class="form-control bg-dark border-secondary text-white py-2 @error('password') is-invalid @enderror" name="password" required>
                                </div>
